...
[![Codecov test coverage](https://codecov.io/gh/selkamand/ggsaves/graph/badge.svg)](https://app.codecov.io/gh/selkamand/ggsaves)
![GitHub Issues or Pull Requests](https://img.shields.io/github/issues-closed/selkamand/ggsaves)
[![code size](https://img.shields.io/github/languages/code-size/selkamand/ggsaves.svg)](https://github.com/selkamand/ggsaves)
![GitHub last commit](https://img.shields.io/github/last-commit/selkamand/ggsaves)
<!-- badges: end -->

ggsaves saves a ggplot as a PDF SVG, 300dpi PNG and TIFF all at once. This is an exceptionally simple convenience package that wraps `ggplot2::ggsave()`.

HTMLwidgets (including ggiraph objects) can also be saved to saved as HTML, SVG, PDF, PNG and TIFF formats with `ggisaves()`
